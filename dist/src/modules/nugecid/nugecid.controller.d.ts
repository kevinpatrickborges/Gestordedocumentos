...
import { CreateDesarquivamentoUseCase, FindAllDesarquivamentosUseCase, FindDesarquivamentoByIdUseCase, UpdateDesarquivamentoUseCase, DeleteDesarquivamentoUseCase, GenerateTermoEntregaUseCase, GetDashboardStatsUseCase, ImportDesarquivamentoUseCase, ImportRegistrosUseCase } from './application/use-cases';
...
export declare class NugecidController {
    ...
    constructor(createDesarquivamentoUseCase: CreateDesarquivamentoUseCase, findAllDesarquivamentosUseCase: FindAllDesarquivamentosUseCase, findDesarquivamentoByIdUseCase: FindDesarquivamentoByIdUseCase, updateDesarquivamentoUseCase: UpdateDesarquivamentoUseCase, deleteDesarquivamentoUseCase: DeleteDesarquivamentoUseCase, generateTermoEntregaUseCase: GenerateTermoEntregaUseCase, getDashboardStatsUseCase: GetDashboardStatsUseCase, importDesarquivamentoUseCase: ImportDesarquivamentoUseCase, importRegistrosUseCase: ImportRegistrosUseCase);
    ...
    getDashboard(currentUser: User, req: Request, res: Response): Promise<void | Response<any, Record<string, any>>>;

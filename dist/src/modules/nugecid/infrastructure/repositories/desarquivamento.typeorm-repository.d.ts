...
export declare class DesarquivamentoTypeOrmRepository implements IDesarquivamentoRepository {
    ...
    findByNumeroNicLaudoAuto(numeroNicLaudoAuto: string): Promise<DesarquivamentoDomain | null>;
    findByNumeroProcesso(numeroProcesso: string): Promise<DesarquivamentoDomain[]>;
    ...
    existsByNumeroNicLaudoAuto(numeroNicLaudoAuto: string): Promise<boolean>;

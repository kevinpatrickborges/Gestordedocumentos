...
let SessionAuthGuard = class SessionAuthGuard extends (0, passport_1.AuthGuard)('session') {
    ...
    handleRequest(err, user, info, context) {
        ...
        if (err || !user) {
            ...
            throw err || new common_1.UnauthorizedException('Sessão inválida ou expirada');
        }
        return user;
    }
};

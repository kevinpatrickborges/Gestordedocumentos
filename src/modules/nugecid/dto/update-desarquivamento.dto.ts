...
export class UpdateDesarquivamentoDto {
  ...
  @IsOptional()
  @IsDateString({}, { message: 'Data da solicitação deve estar no formato válido' })
  ...
  @IsOptional()
  @IsDateString({}, { message: 'Data do desarquivamento SAG deve estar no formato válido' })
  @Transform(({ value }) => (value ? new Date(value) : null))
  ...
  @IsOptional()
  @IsDateString({}, { message: 'Data de devolução ao setor deve estar no formato válido' })
  @Transform(({ value }) => (value ? new Date(value) : null))

...
export class UpdateStatusEnum1756810640639 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_DESARQUIVAMENTOS_URGENTE_PENDENTE"`);

    // 2. Renomear o enum existente
    await queryRunner.query(`ALTER TYPE "status_desarquivamento_enum" RENAME TO "status_desarquivamento_enum_old"`);
    ...
    await queryRunner.query(`ALTER TABLE "desarquivamentos" ALTER COLUMN "status" DROP DEFAULT`);
    ...
    await queryRunner.query(`ALTER TABLE "desarquivamentos" ALTER COLUMN "status" SET DEFAULT 'SOLICITADO'`);
    ...
    await queryRunner.query(`CREATE INDEX "IDX_DESARQUIVAMENTOS_URGENTE_PENDENTE" ON "desarquivamentos" ("urgente", "status") WHERE urgente = true AND status = 'SOLICITADO'`);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TYPE "status_desarquivamento_enum_old" RENAME TO "status_desarquivamento_enum"`);
  }
}

...
export class AlterDesarquivamentosIdToInteger1756827500000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    console.log(`📊 Encontrados ${recordCount} registros na tabela desarquivamentos`);
    ...
    // Remover índices
    await queryRunner.query('DROP INDEX IF EXISTS "IDX_DESARQUIVAMENTOS_NUMERO_NIC"');
    await queryRunner.query('DROP INDEX IF EXISTS "IDX_DESARQUIVAMENTOS_STATUS"');
    await queryRunner.query('DROP INDEX IF EXISTS "IDX_DESARQUIVAMENTOS_TIPO"');
    await queryRunner.query('DROP INDEX IF EXISTS "IDX_DESARQUIVAMENTOS_DATA_SOLICITACAO"');
    await queryRunner.query('DROP INDEX IF EXISTS "IDX_DESARQUIVAMENTOS_CREATED_BY"');
    await queryRunner.query('DROP INDEX IF EXISTS "IDX_DESARQUIVAMENTOS_RESPONSAVEL"');
    await queryRunner.query('DROP INDEX IF EXISTS "IDX_DESARQUIVAMENTOS_URGENTE"');
    await queryRunner.query('DROP INDEX IF EXISTS "IDX_DESARQUIVAMENTOS_DELETED_AT"');
    await queryRunner.query('DROP INDEX IF EXISTS "IDX_DESARQUIVAMENTOS_SETOR"');
    ...
    // Recriar índices
    await queryRunner.query('CREATE UNIQUE INDEX "IDX_DESARQUIVAMENTOS_NUMERO_NIC" ON "desarquivamentos" ("numero_nic_laudo_auto")');
    await queryRunner.query('CREATE INDEX "IDX_DESARQUIVAMENTOS_STATUS" ON "desarquivamentos" ("status")');
    await queryRunner.query('CREATE INDEX "IDX_DESARQUIVAMENTOS_TIPO" ON "desarquivamentos" ("tipo_desarquivamento")');
    await queryRunner.query('CREATE INDEX "IDX_DESARQUIVAMENTOS_DATA_SOLICITACAO" ON "desarquivamentos" ("data_solicitacao")');
    await queryRunner.query('CREATE INDEX "IDX_DESARQUIVAMENTOS_CREATED_BY" ON "desarquivamentos" ("created_by")');
    await queryRunner.query('CREATE INDEX "IDX_DESARQUIVAMENTOS_RESPONSAVEL" ON "desarquivamentos" ("responsavel_id")');
    await queryRunner.query('CREATE INDEX "IDX_DESARQUIVAMENTOS_URGENTE" ON "desarquivamentos" ("urgente")');
    await queryRunner.query('CREATE INDEX "IDX_DESARQUIVAMENTOS_DELETED_AT" ON "desarquivamentos" ("deleted_at")');
    await queryRunner.query('CREATE INDEX "IDX_DESARQUIVAMENTOS_SETOR" ON "desarquivamentos" ("setor_demandante")');
